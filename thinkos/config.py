...
def _resolve_default_root(config_path: str | None) -> str:
    ...
    When the config lives inside .thinkos/, the project root is the parent
    of .thinkos/. Otherwise the config file's directory is the root.
    """
...
def load_config(path: str | None = None) -> dict:
    ...
    if path is None:
        for candidate in [".thinkos/thinkos.json", "thinkos.json", ".thinkos.json"]:
